  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-10">
        <h1 className="text-4xl text-white">Good morning!</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        ...
        <CardTicket
          ticket="total"
          totalTickets="Solucionado"
          text="Nuevo Ticket"
        />
        <CardTicket
          ticket="pending"
          totalTickets="Seguimineto Ticket"
          text="Seguir Ticket"
        />
        <CardTicket
          ticket="inProcess"
          totalTickets="Alta de caja"
          text="Dar de alta"
        />
        <CardTicket
          ticket="close"
      ...
      <div className="bg-secondary-100 p-8 rounded-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center mb-4 bg-secondary-900 p-4 rounded-xl">
          ...
          <div>
            <h5 className="md:hidden text-white font-bold mb-2">Descripción</h5>
            <p>Multiples inicios de sesión fallidos</p>
          </div>
          <div>
            <h5 className="md:hidden text-white font-bold mb-2">Estatus</h5>
